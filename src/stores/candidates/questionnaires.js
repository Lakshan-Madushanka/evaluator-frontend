...
export const useCandidatesQuestionnairesStore = defineStore(
  "candidatesQuestionnaires",
  () => {
    ...
    async function checkAvalability(code) {
      ...
      try {
        const response =
          await candidatesQuestionnairesRequests.checkAvailabilityRequest(code);
        ...
        if (response.name) {
          ...
          let errorMsg =
            "We couldn't found a questionnaire associated with this code !";
