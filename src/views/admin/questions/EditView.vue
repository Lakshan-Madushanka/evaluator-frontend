  ...
  setup() {
    ...
    function setDiffculty(newQuestion) {
      for (let difficulty of difficultyOptions) {
        if (
          newQuestion.data.attributes.hardness === difficulty.name.toUpperCase()
        ) {
    ...
    function setAnswersType(newQuestion) {
      for (let answerType of answersTypeOptions) {
        if (
          ...
          newQuestion.data.attributes.answers_type_single
        ) {
    ...
    function prepareFormData() {
      ...
      let is_answers_type_single =
        state.is_answer_type_single === "true" ? true : false;
