      ...
      >
        ...
        <template #footer>
          <Paginator
            ...
            :rows="
              questionsStore.questions && questionsStore.questions.meta.per_page
            "
            :total-records="
              questionsStore.questions && questionsStore.questions.meta.total
            "
            @page="onPage"
          >
          </Paginator>
  ...
  setup() {
    ...
    const columns = ref([
      ...
      },
      {
        ...
        command: () => {
          columnVisibility.no_of_assigned_answers =
            !columnVisibility.no_of_assigned_answers;
        },
      },
      {
